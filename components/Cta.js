...
const Cta = () => {
  return (
    <div className='flex flex-col-reverse lg:flex-row justify-center items-center gap-5 lg:gap-20 max-w-[1200px] mx-auto'>
      <div className='w-[260px] lg:w-[800px]'>
        <Image
      ...
      <div className='container mx-auto flex flex-col gap-5 items-left justify-center'>
              <p className=' text-slate-800 lg:text-left text-3xl sm:text-3xl md:text-5xl lg:text-6xl font-bold'>Sei pronto a fare un passo verso la <span className='text-primary_dark_seablue'>sostenibilità</span></p>
