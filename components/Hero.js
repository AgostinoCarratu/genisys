...
const Hero = () => {
  return (
    <>
      ...
      <Navbar/>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-6 mx-10">
            <div className="max-w-[660px] flex flex-grow flex-col items-center lg:items-start gap-6 lg:gap-10">
              <p className="text-center lg:text-left text-slate-800 lg:leading-[1.1] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
