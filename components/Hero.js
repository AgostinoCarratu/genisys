      ...
      <Navbar/>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-3 mx-10">
            <div className="max-w-[600px] flex flex-grow flex-col items-center lg:items-start gap-5 lg:gap-10">
              ...
              <button className="text-sm lg:text-xl py-2 lg:py-4 px-6 text-white hover:opacity-70 bg-secondary_dark rounded-full border-none lg:w-52">Affidati a noi</button>
            </div>
            <div className="lg:w-[520px]">
              <Image
                src="/assets/hero-2.png.png"
                width={520}
                height={520}
