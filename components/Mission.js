  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-5 lg:gap-20 max-w-[1100px] mx-auto">
      ...
      <div className="max-w-[600px] flex flex-col lg:items-start gap-6">
        ...
        <p className="lg:leading-normal mb-2">Siamo pionieri nella consulenza e nello sviluppo di progetti innovativi <br className="sm:hidden"/> e miriamo a:</p>
        <ol className="list-decimal pl-12 lg:leading-relaxed">
          ...
          <li className="pl-2 lg:pl-6">Favorire la <span className="font-semibold text-primary_dark_seablue">prosperità</span> di ambiente e aziende</li>
            ...
            {/* Div dell'immagine */}
        <div className="w-[200px] lg:w-[380px] rounded-lg">
        <Image
